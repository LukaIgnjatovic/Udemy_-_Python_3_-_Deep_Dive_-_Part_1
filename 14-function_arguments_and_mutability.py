...
def modify_string(s):
    print("Initial \"s\" memory address is {0}.".format(id(s)))
    s = s + " world."
    print("Final \"s\" memory address is {0}.".format(id(s)))


my_string = "Hello"

print("\"my_string\" memory address is {0}.".format(id(my_string)))
...
def modify_list(lst):
    print("Initial \"lst\" memory address is {0}.".format(id(lst)))
    lst.append(100)
    print("Final \"lst\" memory address is {0}.".format(id(lst)))
...
def modify_tuple(t):
    print("Initial \"t\" memory address is {0}.".format(id(t)))
    t[0].append(100)
    print("Final \"t\" memory address is {0}.".format(id(t)))
